import { BaseHTMLElement, customElement, first, on, onEvent } from 'dnative';
...
export class SpecPerfView extends SpecView {
	...
	async postDisplay() {
		// workaround - because we do not import dnative, and @dnative/infra does (alias is not fully working in vscode apparently)
