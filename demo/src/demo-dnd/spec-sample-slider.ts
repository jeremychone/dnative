...
import { closest, customElement, on, style } from 'dnative';
import { activateDrag, draggable, DraggableEvent } from 'dnative/dnd';
...
function rawSlider(rootEl: HTMLElement) {
	// NOTE: Just a simplistic demonstration to do a draggable with dnative/dnd
