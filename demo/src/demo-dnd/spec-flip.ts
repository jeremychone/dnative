...
import { all, append, BaseHTMLElement, closest, customElement, on, style } from 'dnative';
import { activateDrag, capture } from 'dnative/dnd';
...
function enableDrag(rootEl: HTMLElement) {
	...
	on(rootEl, 'pointerdown', 'c-panel', (pointerDownEvt) => {
		...
		activateDrag(panel, pointerDownEvt, {
			...
			//          dnative/dnd allows to set a custom pointerCapture
