import { customElement, html } from "dnative";
import { run_tests } from "../infra/runner.js";
import { SpecView } from "../infra/spec-view.js";
import { testAll, testAppendAndHtml, testAppendElReturnValue, testAppendEmpty, testAppendHtmlReturnValue, testClosest, testFirst, testFirstElement, testFirstFromHtml, testFirstMultiple, testFirstWithType, testGetFirstException, testGetFirstSuccess, testNext, testPrev, thisAppendToHtml } from "./test-dom-logic.js";

@customElement("spec-test-dom")
export class SpecTestDom extends SpecView {
	name = "test-dom";
	doc = {
		title: "dnative test-dom",
		groups: [
			{
				items: [
					{
