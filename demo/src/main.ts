...
import {
	type DemoFamily, DOM_NATIVE_FAMILY, DND_FAMILY, DEFAULT_SPEC_BY_FAMILY,
	VALID_SPECS_BY_FAMILY, DOM_NATIVE_TEST_FAMILY, DEFAULT_DOM_NATIVE_TEST_SPEC,
	VALID_DOM_NATIVE_TEST_SPECS, DOM_NATIVE_UI_FAMILY
} from "./infra/spec-config.js";
