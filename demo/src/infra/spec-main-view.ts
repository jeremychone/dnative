import { all, append, BaseHTMLElement, customElement, elem, first, onWin } from "dnative";
...
function _render() {
	...
	<header>
		<h1>dnative</h1>
		<span></span>
		<a class="item dnative" href="#dnative/${DEFAULT_SPEC_BY_FAMILY[DOM_NATIVE_FAMILY]}">dnative</a>
		<a class="item draggable" href="#draggable/${DEFAULT_SPEC_BY_FAMILY[DND_FAMILY]}">draggable</a>
		<a class="item dnui" href="#dnui/${DEFAULT_SPEC_BY_FAMILY[DOM_NATIVE_UI_FAMILY]}">dnui</a>
		<span></span>
		<a class="item dnative-test" href="#dnative-test/${DEFAULT_DOM_NATIVE_TEST_SPEC}">dnative-test</a>
	</header>
	<nav>
	</nav>
	<main>
