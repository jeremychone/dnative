...
export type DemoFamily = "dnative" | "draggable" | "dnui";

export const DOM_NATIVE_FAMILY: DemoFamily = "dnative";
export const DND_FAMILY: DemoFamily = "draggable";
export const DOM_NATIVE_UI_FAMILY: DemoFamily = "dnui";
...
export const DOM_NATIVE_TEST_FAMILY = "dnative-test" as const;
